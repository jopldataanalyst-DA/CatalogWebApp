    ...
    <section className="py-8 sm:py-10 border-b border-[var(--color-line)] last:border-0">
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6">
        <div className="flex items-end justify-between gap-4 mb-5">
          <div>
            <div className="flex items-center gap-1.5 text-[var(--color-gold-dark)] mb-1">
              <Sparkles size={14} />
              <span className="text-[11px] uppercase tracking-widest font-semibold">Sales-Ranked</span>
            </div>
          ...
          <Link to="/search" className="hidden sm:flex items-center gap-1 text-sm font-medium text-[var(--color-gold-dark)] hover:underline shrink-0">
            Browse all <ArrowRight size={14} />
          </Link>
        </div>

        <div className="flex gap-4 sm:gap-5 overflow-x-auto pb-2 -mx-4 px-4 sm:mx-0 sm:px-0 snap-x snap-mandatory hide-scrollbar">
  ...
  return (
    <div>
      <div className="relative overflow-hidden border-b border-[var(--color-line)]">
        <div className="max-w-[1600px] mx-auto px-4 sm:px-6 py-16 sm:py-24 text-center">
          <p className="text-[11px] uppercase tracking-[0.25em] text-[var(--color-gold-dark)] font-semibold mb-4">
            Wholesale &middot; B2B Only
          </p>
          <h1
            className="text-4xl sm:text-6xl leading-tight max-w-3xl mx-auto"
            style={{ fontFamily: 'var(--font-display)' }}
          >
            Rajnandini Fashion, sourced by what actually sells
          </h1>
          <p className="text-[var(--color-ink)]/60 max-w-xl mx-auto mt-5 text-sm sm:text-base">
            Every style below is ranked straight from real sales data — no guesswork,
            just what's genuinely moving right now.
          </p>
          <Link
            to="/search"
